...
char* get_fac(Facluty falcuty);
char* get_oks(Oks oks);
...
void add_student(Student *students, int *students_size) {
	...
	scanf("%d", &placeholder);
	student.faculty = placeholder;
	printf("Enter student's oks: ");
	scanf("%d", &placeholder);
	student.oks = placeholder;
...
char* get_fac(Facluty facluty) {
	switch(facluty) {
		case 0: return "Automation";
		case 1: return "Electronics";
		case 2: return "Machine";
		case 3: return "Telecommunications";
		case 4: return "Informatics";
		case 5: return "Computer Systems";
	}
}
